...
class Video(Scene):
    def construct(self):
        ...
        ce = Text("Triangle Inequality: None of the sides can be longer than the sum of the others.").scale(
            0.46).move_to(UP * 3)
        ...
        self.play(dd.animate.rotate(PI / 4).move_to(DOWN * 1.66 + LEFT * 1.64),
                  de.animate.rotate(PI / 5.4).move_to(DOWN * 1.15 + LEFT * 1.04), run_time=2)
